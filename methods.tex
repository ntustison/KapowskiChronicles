...
antsCorticalThickness.sh \
  ...
  -k 0 \
  -o Oasis/ThicknessResults/OAS1_0001_MR1_mpr_n4_anon_sbj_111 \
  -w 0.25 \
  -n 3
\end{lstlisting}
...
\toprule
  ...
  3) L cingulate gyrus & four) R cingulate gyrus \\
  ...
  13) L parahippocampal gyr. & 1four) R parahippocampal gyr. \\
