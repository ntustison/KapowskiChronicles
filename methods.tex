...
\textcolor{red}{FIXME---Atropos enables prior knowledge to guide the
segmentation process where priors are integrated into the optimization
with a user-controlled weight.  We adopt the strategy employed by to balance the prior and data term in our
expectation maximization method:
\begin{equation}
x,
\end{equation}
where ... In this work, we chose an equal weighting of these two
terms.  This decision was based on our historical interest in symmetry
as well as experimentation with different parameter weights.}
