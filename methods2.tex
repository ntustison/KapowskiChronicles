...
\begin{figure*}
  \centering
  \makebox[\textwidth][c]{\includegraphics[width=160mm]{Figures/Kapowski_pipeline2.png}}
...
and limited to the probability range of $[0,1]$.  {\color{blue}{The prior probabilities for the 
