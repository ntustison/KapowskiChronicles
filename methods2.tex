...
multi-atlas label fusion (MALF) \cite{wang2013} step that defines the volumetric regions for each subject.  This was performed using the program {\tt jointfusion}
