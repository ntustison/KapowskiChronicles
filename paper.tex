...
\title{Large-scale evaluation of cortical thickness measurement with
...
developed as part of the ANTs open science effort.  We employ
...
pipeline has a low failure rate (2 of 1200), has high cortical thickness precision and produces
reasonable ``Brain Age'' measurements.  We also show that DiReCT 
reveals expected relationships between cortical thickness,
age and gender.  Additionally, we present novel gender
...
scripts and templates used to produce the results are hosted on the
Neuroimaging Informatics Tools and Resources Clearinghouse (NITRC)
website.  In summary, we establish that ANTs is capable of processing
large-scale multi-site neuroimaging data in order to quantify cortical thickness.
\end{abstract}
