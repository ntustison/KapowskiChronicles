...
during the execution of the different pipeline components. //WHAT PIPELINES?  WHAT COMPONENTS?//
...
precision //RELIABILITY?// do not properly extend to inferences of accuracy or statistical
modeling capabilities.  For evaluation purposes, four open data sets (IXI,
Kirby, NKI, and Oasis), consisting of approximately 1,200 images, were
...
//YOU DON'T WISH TO REPORT THE MEASURES OR THE PERFORMANCE IN THE ABSTRACT?//
...
\begin{keyword}
advanced normalization tools \sep age prediction \sep cortical thickness //\sep MRI//
