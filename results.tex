...
\toprule
\multicolumn{1}{c}{} & \multicolumn{2}{c}{Absolute Error (mm)} & \multicolumn{2}{c}{Percent Variability Error} \\
...
\end{tabular*}
\caption{Mean absolute and percent variability error ($\pm$ standard deviation) of repeated 
...
\end{align}
Error values (including absolute mean errors) for the 32 NIREP regions for both the Oasis and Kirby reproducibility data sets
