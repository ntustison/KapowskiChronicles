...
\begin{figure*}[htb]
  \centering
  \begin{tabular}{c}
  \includegraphics[width=130mm]{repeatabilityLeft.pdf} \\
  \includegraphics[width=130mm]{repeatabilityRight.pdf}
  \end{tabular}
  \caption{\baselineskip 12pt Percent error variability for both ANTs and FreeSurfer pipelines 
...
\begin{figure}[htb]
  \centering
  \begin{tabular}{c}
  \includegraphics[width=130mm]{agePrediction.pdf} 
  \end{tabular}
  \caption{\baselineskip 12pt Age prediction RMSE distributions of linear (left) and random forest (right)
...
\begin{figure}[htb]
  \centering
  \begin{tabular}{c}
  \includegraphics[width=130mm]{genderPrediction.pdf}
  \end{tabular}
  \caption{\baselineskip 12pt Average ROC curve and corresponding AUC distributions
