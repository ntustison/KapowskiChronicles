...
\begin{figure*}
  ...
  \caption{Age vs. thickness plots for several key regions as determined by averaging the
           regional importance random forest plots across pipelines and selecting the
           most discriminative regions (cf Figure \ref{fig:importance}).  Note that all 
           regional plots for both ANTs and FreeSurfer are available online (see Appendix).
           }
