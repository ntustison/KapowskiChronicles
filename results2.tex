...
\begin{figure}
  ...
  \end{tabular}
  \caption{Regional importance random forest plots for (left) ANTs and (right) FreeSurfer using ``MeanDecreaseAccuracy.''  In addition to the 62 cortical regions, as specified by Equation (\ref{eq:lmage}), 
           }
...
\begin{figure*}
  ...
  \caption{Age vs. thickness plots for several key regions as determined by averaging the
           regional importance random forest plots (cf Figure \ref{fig:importance}).
           }
